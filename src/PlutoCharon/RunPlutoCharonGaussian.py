...
def main():
    ...
    output_path = config.output_folder + config.date + "/locations" + config.index + ".csv"
    ...
    PlutoCharonSetupData["subimage"].write_fits(config.output_folder + config.date + "/" + entry + "_PC_subimage")
